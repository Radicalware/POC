...
bool Core::Initialize()
{
    ...
    AddQmlClass(Scanner::Dataset, MoScanner, "MoScanner"); // Type, Local Var, QML Var
    ...
    //MoEngine.rootContext()->setContextProperty("vDisplayTimer", QVariant::fromValue(QString("Exe Time : Never Run")));
...
void Core::SetStopClock(xint unused)
{
    ...
    MoEngine.rootContext()->setContextProperty("vDisplayTimer", QVariant::fromValue(
